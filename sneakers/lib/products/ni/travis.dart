...
class TravisPage extends StatefulWidget {
  const TravisPage({super.key});

  @override
  _TravisPageState createState() => _TravisPageState();
}

class _TravisPageState extends State<TravisPage> {
  String selectedColor = 'Cactus Brown';
  int selectedSize = 0;
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
                ...
                child: PageView(
                  children: [
                    ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/nike/travis 2.jpg',
                        fit: BoxFit.cover,
                    ...
                    ClipRRect(
                      borderRadius: BorderRadius.circular(15),
                      child: Image.asset(
                        'assets/images/nike/travis 1.jpg',
                        fit: BoxFit.cover,
                        width: double.infinity,
                      ),
                    ),
              ...
              // Product Info
              Text(
                'The Nike Travis offers an iconic style with rugged appeal and premium comfort.',
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: const Color(0xFF8B4513), // Cactus Brown color
                  ...
                  onPressed: selectedSize == 0
                      ...
                      : () {
                          addToCart({
                            ...
                            'color': selectedColor,
                            'price': 4000,
                            'image': 'assets/images/nike/travis 1.jpg',
                          });
                        },
