...
class CanaryPage extends StatefulWidget {
  const CanaryPage({super.key});

  @override
  _CanaryPageState createState() => _CanaryPageState();
}

class _CanaryPageState extends State<CanaryPage> {
  String selectedColor = 'Canary Yellow';
  int selectedSize = 0;
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
                ...
                child: PageView(
                  children: [
                    ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/nike/canary 1.jpg',
                        fit: BoxFit.cover,
                    ...
                    ClipRRect(
                      borderRadius: BorderRadius.circular(15),
                      child: Image.asset(
                        'assets/images/nike/canary 2.jpg',
                        fit: BoxFit.cover,
                        width: double.infinity,
                      ),
                    ),
              ...
              // Product Info
              Text(
                'The Nike Canary blends bold colors with everyday versatility.',
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: const Color(0xFFFFD700), // Canary Yellow color
                  ...
                  onPressed: selectedSize == 0
                      ...
                      : () {
                          addToCart({
                            ...
                            'color': selectedColor,
                            'price': 3800,
                            'image': 'assets/images/nike/canary 1.jpg',
                          });
                        },
