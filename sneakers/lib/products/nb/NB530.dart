...
class NB530Page extends StatefulWidget {
  const NB530Page({super.key});

  @override
  _NB530PageState createState() => _NB530PageState();
}

class _NB530PageState extends State<NB530Page> {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              // Product Info
              Text(
                'The NB 530 combines retro aesthetics with modern comfort.',
                  ...
                  onPressed: selectedSize == 0
                      ...
                      : () {
                          addToCart({
                            ...
                            'color': selectedColor,
                            'price': 1800,
                            'image': 'assets/images/NB/530 1.jpg',
                          });
                        },
