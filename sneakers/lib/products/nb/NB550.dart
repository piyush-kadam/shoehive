...
class NB550Page extends StatefulWidget {
  const NB550Page({super.key});

  @override
  _NB550PageState createState() => _NB550PageState();
}

class _NB550PageState extends State<NB550Page> {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              // Product Info
              Text(
                'The NB 550 redefines a classic look with contemporary upgrades and comfort.',
                  ...
                  onPressed: selectedSize == 0
                      ...
                      : () {
                          addToCart({
                            ...
                            'color': selectedColor,
                            'price': 2000,
                            'image': 'assets/images/NB/550 M.jpg',
                          });
                        },
