...
class NB1906RPage extends StatefulWidget {
  const NB1906RPage({super.key});

  @override
  _NB1906RPageState createState() => _NB1906RPageState();
}

class _NB1906RPageState extends State<NB1906RPage> {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              // Product Info
              Text(
                'The NB 1906 R is designed for comfort and style. Featuring premium materials.',
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: selectedColor == 'YellowAccent'
                              ? Colors.black
                              : Colors.transparent,
                          width: 2,
                        ),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        shape: BoxShape.circle,
                        border: Border.all(
                          color: selectedColor == 'PinkAccent'
                              ? Colors.black
                              : Colors.transparent,
                          width: 2,
                        ),
                  ...
                  onPressed: selectedSize == 0
                      ...
                      : () {
                          addToCart({
                            ...
                            'color': selectedColor,
                            'price': 4000,
                            'image': 'assets/images/NB/6r 1.jpg',
                          });
                        },
