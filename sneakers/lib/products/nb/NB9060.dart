...
class NB9060Page extends StatefulWidget {
  const NB9060Page({super.key});

  @override
  _NB9060PageState createState() => _NB9060PageState();
}

class _NB9060PageState extends State<NB9060Page> {
  String selectedColor = 'Mushroom Brown';
  int selectedSize = 0;
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              // Product Info
              Text(
                'NB 9060 offers a bold, futuristic look with enhanced cushioning for comfort.',
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: const Color(0xFF8B5E3C), // Mushroom Brown color
                  ...
                  onPressed: selectedSize == 0
                      ...
                      : () {
                          addToCart({
                            ...
                            'color': selectedColor,
                            'price': 3000,
                            'image': 'assets/images/NB/9060 1.jpg',
                          });
                        },
