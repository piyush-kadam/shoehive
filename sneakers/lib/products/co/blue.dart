...
class _BluePageState extends State<BluePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Converse Stussy Blue', style: GoogleFonts.poppins()),
        centerTitle: true,
      ),
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
                ...
                child: PageView(
                  children: [
                    ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/converse/blue 1.jpg',
                        fit: BoxFit.cover,
                    ...
                    ClipRRect(
                      borderRadius: BorderRadius.circular(15),
                      child: Image.asset(
                        'assets/images/converse/blue 2.jpg',
                        fit: BoxFit.contain,
                        width: double.infinity,
                      ),
                    ),
                    ClipRRect(
                      borderRadius: BorderRadius.circular(15),
                      child: Image.asset(
                        'assets/images/converse/blue 3.jpg',
                        fit: BoxFit.contain,
                        width: double.infinity,
                      ),
                    ),
              ...
              // Product Info
              Text(
                'Converse Stussy Blue offers a vibrant style and unmatched comfort.',
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: selectedSize == 0
                      ...
                      : () {
                          addToCart({
                            'name': 'Converse Stussy Blue',
                            'size': selectedSize,
                            'color': selectedColor,
                            'price': 3000,
                            'image': 'assets/images/converse/blue 1.jpg',
                          });
                        },
