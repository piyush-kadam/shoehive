...
class _OrangePageState extends State<OrangePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Converse Orange', style: GoogleFonts.poppins()),
        centerTitle: true,
      ),
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
                ...
                child: PageView(
                  children: [
                    ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/converse/orange 1.jpg',
                        fit: BoxFit.contain,
                    ...
                    ClipRRect(
                      borderRadius: BorderRadius.circular(15),
                      child: Image.asset(
                        'assets/images/converse/orange 2.jpg',
                        fit: BoxFit.contain,
                        width: double.infinity,
                      ),
                    ),
              ...
              // Product Info
              Text(
                'Brighten your look with Converse Orange sneakers. Stylish and comfy.',
                  ...
                  onPressed: selectedSize == 0
                      ...
                      : () {
                          addToCart({
                            ...
                            'color': selectedColor,
                            'price': 3200,
                            'image': 'assets/images/converse/orange 1.jpg',
                          });
                        },
