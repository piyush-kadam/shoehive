...
class BlackPage extends StatefulWidget {
  ...
  @override
  _BlackPageState createState() => _BlackPageState();
}
...
class _BlackPageState extends State<BlackPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Converse Black', style: GoogleFonts.poppins()),
        centerTitle: true,
      ),
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
                ...
                child: PageView(
                  children: [
                    ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/converse/black 1.jpg',
                        fit: BoxFit.contain,
                    ...
                    ClipRRect(
                      borderRadius: BorderRadius.circular(15),
                      child: Image.asset(
                        'assets/images/converse/black 2.jpg',
                        fit: BoxFit.contain,
                        width: double.infinity,
                      ),
                    ),
              ...
              // Product Info
              Text(
                'Converse Black brings elegance and comfort in one package.',
                  ...
                  onPressed: selectedSize == 0
                      ...
                      : () {
                          addToCart({
                            ...
                            'color': selectedColor,
                            'price': 3200,
                            'image': 'assets/images/converse/black 1.jpg',
                          });
                        },
